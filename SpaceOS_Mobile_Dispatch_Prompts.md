...
**2026-09-08 추가**: 오늘 실측으로 비어 있음이 확인된 자리의 프롬프트는
[docs/prompts-mobile-2026-09-08.md](docs/prompts-mobile-2026-09-08.md) 에 있다
(계정 화면 · 앵커 라벨 정렬 · 글자 정리 · 4P 플로우 · 파일럿 아웃리치).
아래 §1 계정 화면은 그 문서의 **B9** 가 최신판이다 — 백엔드 계약 확인 절차가 붙어 있다.
