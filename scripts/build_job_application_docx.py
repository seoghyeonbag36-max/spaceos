...
def build_talent_profile(out: Path) -> Path:
    ...
    bp.make_table(doc, [
        ...
        ["1단계\n적응",
         "입사 ~ 1년",
         "담당 업무와 기관 프로세스 습득에 집중합니다. 사업비 집행 · 정산 절차, "
         "기술이전 계약 실무, 보육기업 관리 체계를 익히는 것이 우선입니다."],
        ["2단계\n석사",
         "2 ~ 3년차",
         "업무와 직결되는 분야(기술경영 · 창업학 · 데이터사이언스)의 야간 또는 주말 "
         "석사 과정을 병행하고자 합니다. 근무에 지장이 없는 과정으로 한정하며, "
         "기관 규정과 사전 협의를 전제로 합니다."],
        ["3단계\n전문성",
         "4년차 ~",
         "축적한 실무와 연구를 바탕으로 기술사업화 전문가 또는 투자심사 담당자로 "
         "성장하는 것이 목표입니다. 대학이 보유한 기술의 사업화 가능성을 코드 수준에서 "
         "판단할 수 있는 인력이 되고자 합니다."],
...
안녕하십니까.
현재 공고된 채용이 없는 것으로 확인했습니다. 다만 향후 채용 계획이
있으실 때 검토 대상에 포함해 주실 수 있을지 문의드리고자 메일 드립니다.

저는 오프라인 상권을 데이터로 재구성하는 SaaS 두 종을 직접 만들어
운영하고 있습니다.

- PlaceOS — 상권 디지털 트윈 플랫폼 (운영 중: https://placeos.web.app)
  건축물대장을 실측 원천으로 서울 66개 상권의 공실을 건물·층 단위까지
  산출하고, 공실 예측(LSTM)과 업종 추천(GNN)을 붙였습니다. 공실 예측
  MAE는 직전 분기값을 그대로 쓰는 지속성 베이스라인 대비 20.5% 낮습니다.

- Co.I — 창업 코파일럿 AI
  창업 의사결정(입지·업종·가격대·홍보)을 단계별로 보조합니다.

기술지주회사의 일이 '기술을 만드는 쪽'과 '그 기술이 시장에서 값을 갖게
하는 쪽'을 잇는 것이라면, 제가 기여할 수 있는 지점은 기술 실사를 직접
할 수 있다는 점이라고 생각합니다. 사업계획서에 적힌 기술이 실제로
구현 가능한지, 어느 부분이 이미 공개된 것이고 어느 부분이 고유한지를
코드 수준에서 판단할 수 있습니다.

중장기 계획도 함께 말씀드립니다. 입사 후 1년은 담당 업무와 기관의
프로세스를 익히는 데 집중하고, 업무에 적응한 뒤 기술경영 또는 창업학
분야의 야간·주말 석사 과정을 병행하고자 합니다. 근무에 지장이 없는
과정으로 한정하며, 기관 규정과 사전 협의를 전제로 합니다. 장기적으로는
제가 축적한 기술이 대학의 기술사업화 성과로 이어지는 길을 찾고,
기술사업화 전문가 또는 투자심사 담당자로 성장하는 것이 목표입니다.
다만 그것은 제가 귀 기관의 구성원이 되고 대학원 과정을 거친 뒤에
논의할 수 있는 일이며, 지금 그것을 전제로 지원하는 것은 아닙니다.
...
MAIL_IACF = """
○○대학교 산학협력단(창업지원단) 담당자님께

안녕하십니까.
현재 공고된 채용이 없는 것으로 확인했습니다만, 향후 창업지원·기술사업화
분야 채용 계획이 있으실 때 검토해 주실 수 있을지 문의드립니다.

저는 창업 도메인에서 두 개의 서비스를 직접 만들어 운영 중입니다.

- PlaceOS — 상권 디지털 트윈 플랫폼 (운영 중: https://placeos.web.app)
  서울 66개 상권의 공실을 건축물대장 실측으로 건물·층 단위까지 산출하고,
  여기에 공실 예측과 업종 추천, 입점 ROI 시뮬레이션을 결합했습니다.

- Co.I — 창업 코파일럿 AI
  창업 의사결정(입지·업종·가격대·홍보)을 단계별로 보조합니다.

제가 이 직무에 기여할 수 있는 지점은 두 가지입니다.

첫째, 창업기업의 기술 항목을 직접 검토할 수 있습니다. 수집 파이프라인부터
모델, API, 배포까지 전 구간을 다뤄 봤기 때문에 사업계획서의 기술 서술이
실현 가능한지를 판단할 수 있습니다.

둘째, 보육을 받는 쪽의 입장을 압니다. 같은 고민을 하고 있어, 입주기업에게
무엇이 실제로 도움이 되고 무엇이 형식에 그치는지를 구분할 수 있습니다.

중장기 계획도 함께 말씀드립니다. 입사 후 1년은 사업비 집행·정산 절차와
보육기업 관리 체계를 익히는 데 집중하고, 업무에 적응한 뒤 창업학 또는
데이터사이언스 분야의 야간·주말 석사 과정을 병행하고자 합니다. 근무에
지장이 없는 과정으로 한정하며, 기관 규정과 사전 협의를 전제로 합니다.
장기적으로는 제가 축적한 기술이 대학의 기술사업화 성과로 이어지는 길을
찾고, 기술사업화와 창업지원 양쪽을 이해하는 전문 인력이 되고자 합니다.
다만 그것은 제가 귀 기관의 구성원이 되고 대학원 과정을 거친 뒤에
논의할 수 있는 일이며, 지금 그것을 전제로 지원하는 것은 아닙니다.

프로필을 첨부합니다(개인정보 보관 동의 포함).
읽어 주셔서 감사합니다.
...
- [ 새로 추가된 것 한 가지. 예: 거점 확대 / 새 기능 배포 /
  자격 취득 / 정부 지원사업 선정 ]

여전히 귀 기관의 창업지원·기술사업화 업무에 관심이 있습니다.
...
def build_mail_drafts(out: Path) -> Path:
    ...
    bp.h1(doc, "1", "기술지주회사용")
    mail_subject(doc, "[인재풀 등록 문의] 상권 데이터 플랫폼 개발 · 기술 실사 가능 — [성명]")
    mail_body(doc, MAIL_HOLDING)

    p = bp.para(doc, before=0, after=0)
    from docx.enum.text import WD_BREAK
    bp.run(p, "").add_break(WD_BREAK.PAGE)

    bp.h1(doc, "2", "산학협력단 · 창업지원단용")
    mail_subject(doc, "[인재풀 등록 문의] 창업지원 · 기술사업화 분야 — [성명]")
    mail_body(doc, MAIL_IACF)
