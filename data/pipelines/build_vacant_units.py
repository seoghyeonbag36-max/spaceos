...
⚠️ **백엔드에 아직 배선되지 않았다 — 남은 근거 부재 2건 때문이다(2026-08-16 기준).**
산출물은 **49거점 × 12유닛 = 524건**으로 확장됐고(2026-08-16, 이전 13거점),
`/postings` 는 아직 시드 유닛을 쓴다. 아래 셋 중 3번은 풀렸고 1·2번이 남았다.
미산출 5곳(kyunghee·wangsimni·sadang·sukmyung·hyehwa)은 **재실행하면 풀린다**
(2026-08-17 확인). 종전 사유였던 "Tier2(폴리곤근사)라 대장이 없어 상업면적을 못 얻는다"는
**더 이상 사실이 아니다** — 08-17 대장 완주로 54거점 전부가 Tier1 이 됐고(커버리지
96.3~99.6%), 다섯 곳 모두 silver/{slug}/building_attrs.json 에 com_area_flr 이 실재한다
(hyehwa 533동·kyunghee 363·sadang 365·sukmyung 405·wangsimni 569). 이 산출물이 08-16
판이라 아직 반영되지 않았을 뿐이므로, 다시 돌리면 49 → 54 가 된다.
