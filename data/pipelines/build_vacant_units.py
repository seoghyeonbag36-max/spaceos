...
산출물은 **54거점 580유닛**이다(2026-08-22 재실행 완주. 08-16 판은 49거점 524건).
...
⚠️ **산출물은 .gitignore 의 `data/gold/*/*` 에 걸려 추적되지 않는다.** 지금은 아무도
읽지 않아 무해하지만, 배선하는 순간 배포 환경에 파일이 없어 **조용히 시드로 떨어진다**
— calibration.json 이 08-15 까지 겪은 것과 같은 실패 양식이다. 배선보다 추적 예외
(`!data/gold/*/vacant_units.json`, 54파일 388KB)가 먼저다.
