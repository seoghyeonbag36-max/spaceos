...
결과 해석(현행 = 2026-08-16 수요신호 반영본, 40,388노드·7 대분류·95피처·edge_types=all):
  Top-1 63.84% / Top-3 90.80% · macro-F1 0.2124 · lift +4.4%
  ⚠ 2026-09-16: 'KPI Top-3 70% 달성' 표기를 걷었다. 바로 아래 줄이 말하듯 거점
     사전분포만으로 Top-3 89.15% 라 **70% 임계값은 그래프를 들어내도 통과한다.**
     판정은 사전분포 대비 실력으로 한다 → scripts/kpi_baseline.py
...
TOP_K = 3              # 추천 Top-K. 판정 기준은 임계값이 아니라 거점 사전분포 대비 실력이다
SEED = 42
