...
//   로컬 http://localhost:5173 / 프로덕션 https://placeos.web.app (2026-09-13 등록) · 옛 https://spaceos-twin.web.app
//   `*.firebaseapp.com` 은 등록하지 않는다 — 앱이 첫 화면에서 정식 주소로 옮긴다(lib/canonicalHost.ts).
