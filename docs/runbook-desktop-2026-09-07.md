...
> ⚠ **이 문서는 09-07 시점판이다.** 그날의 T1~T4 는 대부분 지나갔다 — 지금 PC 앞에 앉았다면
> [prompts-pc-2026-09-17.md](prompts-pc-2026-09-17.md) 가 최신판이다(첫 입력 프롬프트 + P1~P4).
> 아래 §1 준비(터미널 3개·인코딩)는 여전히 유효하다.
