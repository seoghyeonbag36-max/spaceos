...
- 성능 목표: **AI 는 '정확도 70%+' 를 2026-09-16 에 폐기**하고 베이스라인 대비 실력으로 간다 (무정보 규칙이 그 선을 이미 넘었다 → [finding-kpi-leak-2026-09-16.md](finding-kpi-leak-2026-09-16.md)). 지도·건물 상세 로딩 <3초 · API p95 <200ms 는 **계측 코드가 아직 없다** — 측정 없이 달성으로 적지 않는다
